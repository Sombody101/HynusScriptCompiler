...
public interface IHScriptVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitStatement([NotNull] HScriptParser.StatementContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitInterpolatedStringExpression([NotNull] HScriptParser.InterpolatedStringExpressionContext context);
	/// <summary>
